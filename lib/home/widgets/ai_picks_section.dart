...
class AiPicksSection extends StatefulWidget {
  const AiPicksSection({super.key, required this.books});
...
class _AiPicksSectionState extends State<AiPicksSection>
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        SectionHeader(
          title: "Identity Recommendations ✨",
          subtitle: 'Calibrated to match your target goal',
          badge: const GoldBadge(label: 'New'),
          onSeeAll: () {},
        ),
        SizedBox(
          height: 300,
